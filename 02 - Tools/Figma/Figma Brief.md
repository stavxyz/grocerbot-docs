...
The target file: `https://www.figma.com/design/nBmhDyEDpFPrMq0ztmHDb0/`, file key `nBmhDyEDpFPrMq0ztmHDb0`, a copy of the DRAPER System Docs file. It has three empty GrocerBot pages, SYSTEM LEGEND, SYSTEM REGISTRY, VISUAL DOCUMENTATION, and three DRAPER example pages, Ex Systrem Legend, Ex System Registry, Ex Outputs, which are example material and never a source about GrocerBot. Its local variables and text styles are DRAPER's and are the tokens GrocerBot builds with.
