*Example material from the original DRAPER repo, kept verbatim below this line. This is the 8.12 written standard for the FigJam era; the live Figma file moved past it, as recorded in `02 - Tools/Figma/Live Legend Read 26.09.06.md`. File paths it names refer to that repo's layout, not this one. See Example Brief.md.*
